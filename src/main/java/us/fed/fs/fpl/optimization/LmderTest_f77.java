...
*/
      ...
      if (iflag[1] == 1) LmderTest_f77.ssqfcn_f77(m,n,x,fvec,this.nprob);
      if (iflag[1] == 2) LmderTest_f77.ssqjac_f77(m,n,x,fjac,this.nprob);
   ...
   public static void ssqjac_f77(int m, int n, double x[], double fjac[][],
                                 int nprob) {
