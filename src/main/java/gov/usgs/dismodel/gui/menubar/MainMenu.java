...
public class MainMenu extends JMenuBar {
	...
	private class Data_GpsMenu extends JMenu {
		public Data_GpsMenu(String title) {
			...
			this.add(new LoadStationMenuItem(
					"Load Station Locations & Names...", allGuiVars));
			this.add(new LoadDisplacementMenuItem("Load Displacements...",
					allGuiVars));
			this.add(new LoadCovMenuItem("Load Covariance Matrix...",
					allGuiVars));
		}
	...
	private class Data_BatchMenu extends JMenu {
		public Data_BatchMenu(String title) {
			...
			this.add(new ProcessGreensFilesMenuItem(
					"Green's function file(s)...", allGuiVars));
		}
