...
public class LatLon implements Serializable {
    ...
    protected final Angle latitude;
    protected final Angle longitude;
	...
	/**
     * Returns the distance from another LatLng in meters. By default, this distance is calculated
     * given the default equatorial earth radius of 6378137 meters.
     * The earth is approximated as a sphere, hence the distance could be off as much as 0.3%, especially in the polar extremes.
     * @param other
     * @return
     */
