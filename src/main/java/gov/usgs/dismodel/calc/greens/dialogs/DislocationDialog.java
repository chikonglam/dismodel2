...
public class DislocationDialog extends javax.swing.JDialog implements MouseClicked,
    ...
    private void initComponents() {
        ...
        midpointFixed.setEnabled(false);
        ...
        selectTwoLabel.setFont(new java.awt.Font("sansserif", 1, 13)); // NOI18N
        ...
        orientationLabel.setFont(new java.awt.Font("DejaVu Sans", 1, 13)); // NOI18N
        ...
        specifyDimensionsLabel.setFont(new java.awt.Font("sansserif", 1, 13)); // NOI18N
        ...
        aspectRatioLB.setEnabled(false);
        ...
        aspectRatioUB.setEnabled(false);
        ...
        upperBoundLabel2.setFont(new java.awt.Font("DejaVu Sans", 1, 13)); // NOI18N
    ...
    private void endpoint1xValueActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }                                               

    private void endpoint1xLBActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void aspectRatioCBActionPerformed(java.awt.event.ActionEvent evt) {                                              
        if (aspectRatioCB.isSelected()) {
           aspectRatioFixed.setEnabled(true);
            setFixed(aspectRatioFixed.isSelected(), aspectRatioValue, aspectRatioLB, aspectRatioUB);
        } else {
            aspectRatioFixed.setEnabled(false);
            aspectRatioValue.setEditable(false);
            aspectRatioLB.setEditable(false);
            aspectRatioUB.setEditable(false);
        }
}                                             

    private void lengthCBActionPerformed(java.awt.event.ActionEvent evt) {                                         
        if (lengthCB.isSelected()) {
           lengthFixed.setEnabled(true);
            setFixed(lengthFixed.isSelected(), lengthValue, lengthLB, lengthUB);

        } else {
            lengthFixed.setEnabled(false);
            lengthValue.setEditable(false);
            lengthLB.setEditable(false);
            lengthUB.setEditable(false);
        }
}                                        
    ...
    private void endpoint1FixedActionPerformed(java.awt.event.ActionEvent evt) {                                               
        setFixed(endpoint1Fixed.isSelected(), endpoint1xValue, endpoint1xLB, endpoint1xUB);
        setFixed(endpoint1Fixed.isSelected(), endpoint1yValue, endpoint1yLB, endpoint1yUB);
        if (endpoint1Fixed.isSelected())
            nFixed = nFixed++;
        else
            nFixed = nFixed--;
    }                                              
    ...
    private void endpoint2FixedActionPerformed(java.awt.event.ActionEvent evt) {                                               
        setFixed(endpoint2Fixed.isSelected(), endpoint2xValue, endpoint2xLB, endpoint2xUB);
        setFixed(endpoint2Fixed.isSelected(), endpoint2yValue, endpoint2yLB, endpoint2yUB);
        if (endpoint2Fixed.isSelected())
            nFixed = nFixed++;
        else
            nFixed = nFixed--;
    }                                              
    ...
    private void midpointFixedActionPerformed(java.awt.event.ActionEvent evt) {                                              
        setFixed(midpointFixed.isSelected(), midpointxValue, midpointxLB, midpointxUB);
        setFixed(midpointFixed.isSelected(), midpointyValue, midpointyLB, midpointyUB);
        if (midpointFixed.isSelected())
            nFixed = nFixed++;
        else
            nFixed = nFixed--;
    }                                             
    ...
    private void depthFixedActionPerformed(java.awt.event.ActionEvent evt) {                                           
        setFixed(depthFixed.isSelected(), depthValue, depthLB, depthUB);
        if (depthFixed.isSelected())
            nFixed = nFixed++;
        else
            nFixed = nFixed--;
    }                                          
    ...
    private void aspectRatioFixedActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        setFixed(aspectRatioFixed.isSelected(), aspectRatioValue, aspectRatioLB, aspectRatioUB);
        if (aspectRatioFixed.isSelected())
            nFixed = nFixed++;
        else
            nFixed = nFixed--;
    }                                                
    ...
    private void specifyEndpoint2ActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (specifyEndpoint2.isSelected()) {
            point2Panel.setEnabled(true);
            aspectRatioCB.setSelected(false);
            lengthCB.setSelected(true);
            widthCB.setSelected(true);
            endpoint2Fixed.setEnabled(true);
        } else {
            point2Panel.setEnabled(false);
            endpoint2Fixed.setEnabled(false);
        }
    }                                                
    ...
    private void midpointRBActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // disable the panels
        endPointsPanel.setEnabled(false);
        midPointPanel.setEnabled(false);

        // disable all
        midpointFixed.setEnabled(false); endpoint1Fixed.setEnabled(false);
        endpoint1xValue.setEnabled(false); endpoint1xLB.setEnabled(false); endpoint1xUB.setEnabled(false);
        endpoint1yValue.setEnabled(false); endpoint1yLB.setEnabled(false); endpoint1yUB.setEnabled(false);
        endpoint2xValue.setEnabled(false); endpoint2xLB.setEnabled(false); endpoint2xUB.setEnabled(false);
        endpoint2yValue.setEnabled(false); endpoint2yLB.setEnabled(false); endpoint2yUB.setEnabled(false);
        midpointxValue.setEnabled(false); midpointxLB.setEnabled(false); midpointxUB.setEnabled(false);
        midpointyValue.setEnabled(false); midpointyLB.setEnabled(false); midpointyUB.setEnabled(false);
        // then enable the correct buttons
        if (midpointRB.isSelected()) {
             midPointPanel.setEnabled(true);
            setFixed(midpointFixed.isSelected(), midpointxValue, midpointxLB, midpointxUB);
            setFixed(midpointFixed.isSelected(), midpointyValue, midpointyLB, midpointyUB);
            midpointFixed.setEnabled(true);

        } else {
            endPointsPanel.setEnabled(true);
            endpoint1Fixed.setEnabled(true);
            setFixed(endpoint1Fixed.isSelected(), endpoint1xValue, endpoint1xLB, endpoint1xUB);
            setFixed(endpoint1Fixed.isSelected(), endpoint1yValue, endpoint1yLB, endpoint1yUB);
            setFixed(endpoint2Fixed.isSelected(), endpoint2xValue, endpoint2xLB, endpoint2xUB);
            setFixed(endpoint2Fixed.isSelected(), endpoint2yValue, endpoint2yLB, endpoint2yUB);
    ...
    private void widthCBActionPerformed(java.awt.event.ActionEvent evt) {
       if (widthCB.isSelected()) {
           widthFixed.setEnabled(true);
            setFixed(widthFixed.isSelected(), widthValue, widthLB, widthUB);

        } else {
            widthFixed.setEnabled(false);
            widthValue.setEditable(false);
            widthLB.setEditable(false);
            widthUB.setEditable(false);
        }
    }
    ...
    */
    ...
    private javax.swing.JLabel selectTwoLabel;
