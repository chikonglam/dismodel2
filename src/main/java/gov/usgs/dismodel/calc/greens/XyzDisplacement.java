 ...
 * This class does not have such geodetic info, so we labeled it for use as
 * a difference between positions, for which use this
 * could be directly compatible with local or global Cartesian coordinates. 
 * @author cforden
 *
 */
public class XyzDisplacement implements Serializable {
	...
	/**
	 * @param xyz An array comprising easting, northing, and up, in meters.
	 */
	...
	public double getAxis(final int axisIndex) throws SolverException {
	    if (axisIndex >= AXES || axisIndex < 0)
	        throw new SolverException("XyzDisplacement.getAxis(axisIndex) " +
	...
	/** Adds the passed displacement, axis by axis, into this instance. 
	 * This method does not create a copy of this instance.
	 * @param RHS Right Hand Side operand to be added.
